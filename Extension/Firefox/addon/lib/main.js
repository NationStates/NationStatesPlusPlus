...
pageMod.PageMod({
  ...
  contentScriptFile: [self.data.url("jquery-2.0.3.min.js"), self.data.url("background.js"), self.data.url("js/bootstrap-fileupload.min.js"),
				...
				self.data.url("js/administration.js"), self.data.url("js/settings.js"), self.data.url("js/activity.js"), self.data.url("js/history.js"), self.data.url("js/puppet_command.js")],
