		...
		if (localStorage.getItem("read_security_incident") == null) {
			getUserData().update(function() {
				...
				if (readReport) {
					...
					if (isDarkTheme()) {
						$("#security_update").attr("style", $("#security_update").attr("style") + "color: black !important;");
						$("#security_update").find("h2").attr("style", $("#security_update").find("h2").attr("style") + "color: black !important;");
					}
