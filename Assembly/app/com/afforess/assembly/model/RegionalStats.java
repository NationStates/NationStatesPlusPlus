	...
	public boolean updateStats(DatabaseAccess access) throws SQLException {
		...
		try {
			...
			if (result.next()) {
				...
				this.environment = (int)Math.floor(result.getFloat("environment"));
				this.socialEquality = (int)Math.floor(result.getFloat("socialequality"));
				this.education = (int)Math.floor(result.getFloat("education"));
				this.lawAndOrder = (int)Math.floor(result.getFloat("lawandorder"));
				this.administration = (int)Math.floor(result.getFloat("administration"));
				this.welfare = (int)Math.floor(result.getFloat("welfare"));
				this.spirituality =(int)Math.floor( result.getFloat("spirituality"));
				this.defence = (int)Math.floor(result.getFloat("defence"));
